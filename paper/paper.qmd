...
plot1 <- ggplot(data = analysis_data, aes(x = days_to_death, y = pathologic_stage, color = treatment_type)) +
  ...
  labs(x = "Days to Death", y = "Pathologic Stage",
  ...
  guides(color = guide_legend(title.position = "top", title.vjust = 0.5)) +
  ggtitle("Pathologic Stage vs. Time vs. Treatment Type") +
  labs(caption = "Relationship between pathologic stage, time to death, and treatment type")
...
plot3 <- ggplot(data = analysis_data, aes(x = days_to_death,
  ...
  labs(caption = "Relationship between lymph node involvement, time to death, and treatment type")  
# Adjusted to caption
